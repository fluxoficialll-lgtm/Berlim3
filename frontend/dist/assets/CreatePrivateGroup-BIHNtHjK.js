import{u as k,r as t,j as e,c as g,g as _}from"./index-BC19Iu_T.js";import{p as z}from"./postService-XFLx8Vj8.js";import{I as F}from"./ImageCropModal-DKSoCquK.js";import{g as G}from"./idGenerator-C8OoQYlS.js";const P=()=>{const i=k(),[n,u]=t.useState(""),[d,m]=t.useState(""),[l,b]=t.useState(void 0),[p,h]=t.useState(null),[c,x]=t.useState(!1),[v,f]=t.useState(!1),[w,j]=t.useState(""),y=r=>{const o=r.target.files?.[0];if(o){const a=new FileReader;a.onload=s=>{j(s.target?.result),f(!0)},a.readAsDataURL(o)}},C=r=>{b(r),fetch(r).then(o=>o.blob()).then(o=>{const a=new File([o],"group_cover.jpg",{type:"image/jpeg"});h(a)})},N=()=>{window.history.state&&window.history.state.idx>0?i(-1):i("/create-group")},I=async r=>{if(r.preventDefault(),!c){x(!0);try{const o=g.getCurrentUserId(),a=g.getCurrentUserEmail();let s=l;p&&(s=await z.uploadMedia(p,"group_covers"));const S={id:G(),name:n,description:d,coverImage:s,isVip:!1,isPrivate:!0,lastMessage:"Grupo privado criado.",time:"Agora",creatorId:o||"",creatorEmail:a||void 0,memberIds:o?[o]:[],adminIds:o?[o]:[]};await _.createGroup(S),i("/groups")}catch{alert("Erro ao criar grupo privado.")}finally{x(!1)}}};return e.jsxs("div",{className:"min-h-screen bg-[radial-gradient(circle_at_top_left,_#0c0f14,_#0a0c10)] text-white font-['Inter'] flex flex-col overflow-x-hidden",children:[e.jsx("style",{children:`
