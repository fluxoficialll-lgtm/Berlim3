// Este arquivo representa a tela onde o usuário escolhe o tipo de campanha de anúncio.
// Ele decide se quer criar um novo anúncio do zero ou impulsionar conteúdo existente.
...
/**
 * Componente: AdCampaignTypeSelector
 * Propósito: Tela inicial do fluxo de criação de anúncios, onde o usuário escolhe
 * entre criar um anúncio novo ou impulsionar um post/vídeo existente.
 */
export const AdCampaignTypeSelector: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0c10] text-white font-['Inter'] flex flex-col overflow-x-hidden">
            {/* Cabeçalho padrão do fluxo de criação de anúncios */}
            <AdSelectionHeader 
            ...
            <main className="flex-1 flex flex-col justify-center max-w-[500px] mx-auto w-full px-6 py-10">
                ...
                {/* Caixa de informações sobre a plataforma de anúncios */}
                <AdSelectionInfoBox />
                
                {/* Rodapé com a versão da plataforma */}
