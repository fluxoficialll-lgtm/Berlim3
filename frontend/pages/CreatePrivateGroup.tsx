// Este arquivo define o formulário para a criação de um novo grupo privado.
...
/**
 * Componente: CreatePrivateGroup
 * Propósito: Fornece um formulário para que os usuários criem um novo grupo privado.
 * O usuário pode definir o nome, descrição e uma imagem de capa para o grupo.
 * A privacidade é definida como `isPrivate: true`.
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        const newGroup: Group = {
          ...
          isVip: false,
          isPrivate: true, // Define o grupo como privado.
